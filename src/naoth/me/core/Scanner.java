 ...
 * @author claas
 * 
 * Edit Nika: Kommentare in einer Keyframe-Datei, die mit "/" anfangen, 
 * werden beim Lesen der Datei übersprungen. D.h. kommentierte Dateien 
 * können eingelesen werden, aber wenn sie gespeichert werden, fehlen die 
 * Kommentare. Siehe Methode skipSpace() und Klassenvariable LineComment.
 */
